...
for the put devices eswitches Id system users operation typically these are written to a http.Request
*/
...
func (o *PutDevicesEswitchesIDSystemUsersParams) WithBody(body *models.Model67) *PutDevicesEswitchesIDSystemUsersParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the put devices eswitches Id system users params
func (o *PutDevicesEswitchesIDSystemUsersParams) SetBody(body *models.Model67) {
	o.Body = body
}
