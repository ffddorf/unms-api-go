...
for the put devices erouters Id router ospf operation typically these are written to a http.Request
*/
...
func (o *PutDevicesEroutersIDRouterOspfParams) WithBody(body *models.Model66) *PutDevicesEroutersIDRouterOspfParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the put devices erouters Id router ospf params
func (o *PutDevicesEroutersIDRouterOspfParams) SetBody(body *models.Model66) {
	o.Body = body
}
