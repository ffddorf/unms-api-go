...
type OspfConfig struct {
	...
	RedistributeConnected *OspfConfigRedistributeConnected `json:"redistributeConnected,omitempty"`

	RedistributeStatic *OspfConfigRedistributeConnected `json:"redistributeStatic,omitempty"`

	RedistributeDefaultRoute *OspfConfigRedistributeDefaultRoute `json:"redistributeDefaultRoute,omitempty"`
}
