...
package unms
// InterfaceAddressType : nullable string
type InterfaceAddressType string

// List of InterfaceAddressType
const (
	DHCP InterfaceAddressType = "dhcp"

	DHCPV6 InterfaceAddressType = "dhcpv6"

	STATIC InterfaceAddressType = "static"
)
