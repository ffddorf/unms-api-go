...
type InlineResponse2001 struct {
	IsCloudSmtpAvailable bool `json:"isCloudSmtpAvailable,omitempty"`

	CanConfigureMaps bool `json:"canConfigureMaps,omitempty"`

	LatestVersionUrl string `json:"latestVersionUrl,omitempty"`

	UpdateVersionOverride string `json:"updateVersionOverride,omitempty"`

	UseCustomSslCert bool `json:"useCustomSslCert,omitempty"`
}
