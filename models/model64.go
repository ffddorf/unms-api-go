...
func (m *Model64) validateAdminPassword(formats strfmt.Registry) error {
...
func (m *Model64) validateEnabled(formats strfmt.Registry) error {
...
func (m *Model64) validateName(formats strfmt.Registry) error {
...
func (m *Model64) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Model64) UnmarshalBinary(b []byte) error {
	var res Model64
