...
const (
	...
	// DeviceAttributesCountryGuineaBissau captures enum value "Guinea-Bissau"
	DeviceAttributesCountryGuineaBissau string = "Guinea-Bissau"
	...
	// DeviceAttributesCountryTimorLeste captures enum value "Timor-Leste"
	DeviceAttributesCountryTimorLeste string = "Timor-Leste"
	...
	// DeviceAttributesCountryVirginIslandsUS captures enum value "Virgin Islands (U.S.)"
	DeviceAttributesCountryVirginIslandsUS string = "Virgin Islands (U.S.)"
...
func (m *DeviceAttributes) validateCountryEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, deviceAttributesTypeCountryPropEnum); err != nil {
		return err
	}
	return nil
}
