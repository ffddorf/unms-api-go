...
func (m *Model10) validateMessage(formats strfmt.Registry) error {
...
func (m *Model10) validateResult(formats strfmt.Registry) error {
...
func (m *Model10) validateVersion(formats strfmt.Registry) error {
