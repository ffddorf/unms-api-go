...
package unms
// OspfAuthorization : off - Off, md5 - MD5/sec, plaintext-password - Plain text
type OspfAuthorization string

// List of OSPFAuthorization
const (
	OFF OspfAuthorization = "off"

	MD5 OspfAuthorization = "md5"

	PLAINTEXT_PASSWORD OspfAuthorization = "plaintext-password"
)
