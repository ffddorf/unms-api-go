...
// APIClient manages communication with the UNMS API API v2.1
...
type APIClient struct {
	...
	FirmwaresApi *FirmwaresApiService

	LogsApi *LogsApiService

	NmsApi *NmsApiService

	OutagesApi *OutagesApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.FirmwaresApi = (*FirmwaresApiService)(&c.common)
	c.LogsApi = (*LogsApiService)(&c.common)
	c.NmsApi = (*NmsApiService)(&c.common)
	c.OutagesApi = (*OutagesApiService)(&c.common)
